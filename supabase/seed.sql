...
INSERT INTO gallery_items (category_id, title, description, media_type, url, thumbnail_url, is_featured, is_published, display_order) VALUES
  ...
  ((SELECT id FROM studio_cat), 'Beat Production Station', 'MIDI controllers and MPC workflow.', 'image', 'https://images.unsplash.com/photo-1507838153414-b4b713384a76?w=1200&q=80', 'https://images.unsplash.com/photo-1507838153414-b4b713384a76?w=600&q=80', FALSE, TRUE, 5),
  ((SELECT id FROM studio_cat), 'Outboard Equipment Rack', 'Preamps, compressors, and converters.', 'image', 'https://images.unsplash.com/photo-1571266028243-d220c6a3adc0?w=1200&q=80', 'https://images.unsplash.com/photo-1571266028243-d220c6a3adc0?w=600&q=80', FALSE, TRUE, 6)
ON CONFLICT DO NOTHING;
