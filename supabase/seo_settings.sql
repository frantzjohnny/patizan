...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'site_settings' AND column_name = 'og_image_url') THEN
    ALTER TABLE public.site_settings ADD COLUMN og_image_url TEXT DEFAULT 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=1200&h=630&fit=crop&q=85';
  END IF;
...
SET
  ...
  og_image_url = COALESCE(og_image_url, 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=1200&h=630&fit=crop&q=85'),
